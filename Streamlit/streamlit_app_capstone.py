...
def main():
    ...
    elif option == 'Night Life' and Review == 'Positive':
        st.write(night_life.loc[night_life['Sentiments']== 'Positive'])
    elif option == 'Night Life' and Review == 'Neutral':
        st.write(night_life.loc[night_life['Sentiments']== 'Neutral'])
    elif option == 'Night Life' and Review == 'Negative':
        st.write(night_life.loc[night_life['Sentiments']== 'Negative'])
    ...
    elif option == 'Value for Money' and Review == 'Positive':
        st.write(value.loc[value['Sentiments']== 'Positive'])
    elif option == 'Value for Money' and Review == 'Neutral':
        st.write(value.loc[value['Sentiments']== 'Neutral'])
    elif option == 'Value for Money' and Review == 'Negative':
